/**
\brief Register definitions for the Atmega128RFA1 microcontroller.
...
(<tt>RG_IRQ_STATUS</tt>) to know what type it is, among the following.
*/
...
#  define CLKM_250KHz               (6)
	/** Constant CLKM_62_5KHz for sub-register @ref SR_CLKM_CTRL
    * @ingroup apiHalPHY233Const
    */
#  define CLKM_62_5KHz               (7)
...
/** Constant RF233 for PART_NUM */
#define AT86RF233_PART_NUM   (0x0B)

/** Constant RF233 for VERSION_NUM */
#define AT86RF233_VERSION_NUM   (0x01)
