...
#define RESYNCHRONIZATIONGUARD       10 //5 // in 32kHz ticks. min distance to the end of the slot to successfully synchronize //Sven_32
#define US_PER_TICK                 58 // number of us per 32kHz clock tick  //Sven_32
#define EBPERIOD                    58 // in seconds: sending EB every 30 seconds
#define MAXKAPERIOD               3815 // in slots: @15ms per slot -> ~30 seconds. Max value used by adaptive synchronization.
#define DESYNCTIMEOUT             4450 // in slots: @15ms per slot -> ~35 seconds. A larger DESYNCTIMEOUT is needed if using a larger KATIMEOUT.
...
enum ieee154e_atomicdurations_enum {
   ...
   TsShortGT                 =    7,                  //   500us
#else
   TsTxOffset                =  250, //131,                  //  4000us
   TsLongGT                  =   83, //43,                  //  1300us
   TsTxAckDelay              =  289, //151,                  //  4606us
   TsShortGT                 =   31, //16,                  //   500us
#endif
...
#else
   wdRadioTx                 =   63, //33,                  //  1000us (needs to be >delayTx)
   wdDataDuration            =  313, //164,                  //  5000us (measured 4280us with max payload)
   wdAckDuration             =   187, //98,                  //  3000us (measured 1000us)
#endif
};
